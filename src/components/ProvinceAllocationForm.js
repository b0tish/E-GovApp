        ...
        <div className="w-screen min-h-screen flex justify-center items-center">
            ...
            <form method="POST">
                <div className="pt-6">
                    ...
                    <select className="w-full p-3 border-2 border-gray-200 rounded-lg bg-white" id="ministry" onChange={e => {
                        setBudget(ministries.filter(ministry => ministry["name"] === e.target.value)[0]["budget"])
                    }}>
