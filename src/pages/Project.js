...
function Project() {
  ...
  const data = ["project1", "project 2"]

  const [filteredByLevel, setFilteredByLevel] = useState(data);
  const [filteredOfficials, setFilteredOfficials] = useState(data);
